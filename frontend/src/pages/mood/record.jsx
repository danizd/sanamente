...
export default function MoodRecordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = {
        ...
        positive_emotions: Array.isArray(positiveEmotions) ? positiveEmotions : [positiveEmotions],
        negative_emotions: Array.isArray(negativeEmotions) ? negativeEmotions : [negativeEmotions],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-fuchsia-50 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      <div className="main-glass w-full rounded-3xl shadow-2xl p-8">
        <h1 className="text-3xl font-extrabold mb-6 text-center text-blue-700 dark:text-fuchsia-300 drop-shadow-lg">
